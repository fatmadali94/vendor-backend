...
exports.getPartProvider = exports.createPartProvider = exports.updatePartProvider = exports.deletePartProvider = exports.getAllPartProviders = void 0;
var mongoose = require("mongoose");
const partProviders_1 = require("../../db/parts/partProviders");
const providers_1 = require("../../db/providers");
const cloudinary_1 = __importDefault(require("../../utils/cloudinary"));
const getAllPartProviders = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const providers = yield (0, partProviders_1.getPartProviders)();
        const verifiedPartProviders = yield (0, providers_1.getVerifiedPartProviders)();
        const allProviders = [...providers, ...verifiedPartProviders];
...
exports.getAllPartProviders = getAllPartProviders;
const deletePartProvider = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { id } = req.params;
        const provider = yield (0, partProviders_1.deletePartProviderById)(id);
        if (provider.image) {
...
exports.deletePartProvider = deletePartProvider;
const updatePartProvider = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const _id = req.params.id;
        const oldProvider = yield partProviders_1.PartProviderModel.findOne({ _id });
...
exports.updatePartProvider = updatePartProvider;
const createPartProvider = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (req.body.image) {
            ...
            newProvider = new partProviders_1.PartProviderModel(Object.assign(Object.assign({}, req.body), { image: {
                    public_id: result.public_id,
                    url: result.secure_url,
                } }));
        }
        else {
            newProvider = new partProviders_1.PartProviderModel(Object.assign({}, req.body));
        }
...
exports.createPartProvider = createPartProvider;
const getPartProvider = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const provider = yield (0, partProviders_1.getPartProviderById)(id);
...
exports.getPartProvider = getPartProvider;
